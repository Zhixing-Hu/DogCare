            ...
            <nav className='header'>
                <div className={top_menu_class}>                    
                    ...
                    <div className='header_nav_right open_sans'>
                        ...
                        <NavLink to='/Live' activeClassName='highlighted' onClick={this.closeNav}>Live</NavLink>
                        <NavLink to='/Apply' activeClassName='highlighted' onClick={this.closeNav}>Apply</NavLink>
                        <NavLink to='/Partners' activeClassName='highlighted' onClick={this.closeNav}>Partners</NavLink>
                    </div>
