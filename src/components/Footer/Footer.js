        ...
        return(
            <nav className='footer_nav'>
                <div className='footer_contacts'>
                    ...
                    <a href='https://www.facebook.com/pawspetpad/' target='_blank' rel="noopener noreferrer">
                        <FontAwesomeIcon icon={['fab', 'facebook-square']} className='footer_icons'/>
                    </a>
                    <a href='https://www.instagram.com/insta_dog/' target='_blank' rel="noopener noreferrer">
